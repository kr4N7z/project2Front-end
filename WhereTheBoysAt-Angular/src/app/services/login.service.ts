...
export class LoginService {
  ...
  login(loginCredentials):Observable<Object>{
    ...
    return this.httpClient.post<Friend>("http://ec2-54-237-35-242.compute-1.amazonaws.com:8088/WhereTheBoysAt/user/login", body,{headers:headers})  as Observable<Friend>;
